...
class Stage3Sampler : public protocols::abinitio::ClassicAbinitio {
public:
...
class Stage3Mover : public FragInsertionMover
{
public:
public:
  core::scoring::ScoreFunctionOP sfxn;
  boost::shared_ptr<Stage3Sampler> sampler;
  core::fragment::FragSetCOP fragset_small, fragset_large;
  core::kinematics::MoveMapOP mm_;

  Stage3Mover(core::scoring::ScoreFunctionOP sfxn_, core::fragment::FragSetOP frag_set_, core::fragment::FragSetOP frag_set_large, std::string stage = "stage4") : FragInsertionMover(sfxn_, frag_set_, frag_set_large) {
    mm_ = core::kinematics::MoveMapOP(new core::kinematics::MoveMap());
    mm_->set_bb(true);
    fragset_small = core::fragment::FragSetCOP(frag_set_);
    fragset_large = core::fragment::FragSetCOP(frag_set_large);
    sampler =  boost::shared_ptr<Stage3Sampler>(new Stage3Sampler(fragset_small, fragset_large, mm_->clone() , stage) );
    sfxn = sfxn_;
  }
...
class NoGreedyStage3Mover : public Stage3Mover
{
public:
  NoGreedyStage3Mover(core::scoring::ScoreFunctionOP sfxn_, core::fragment::FragSetOP frag_set_, core::fragment::FragSetOP frag_set_large, std::string stage) : Stage3Mover(sfxn_, frag_set_, frag_set_large, stage) {
  }
...
public:
  enum FragMoverTypes {
    my_frag_insertion, greedy_search, stage3mover, ILS_as_julia
  };
  ...
  static boost::shared_ptr<FragInsertionMover> get(FragMoverTypes type, core::scoring::ScoreFunctionOP scorefxn, core::fragment::FragSetOP frag_set_, core::fragment::FragSetOP frag_set_large, std::string stage_name) {
    ...
    case stage3mover: {
      frag_mover = boost::shared_ptr<FragInsertionMover>( new Stage3Mover(scorefxn, frag_set_, frag_set_large, stage_name));
      break;
    }
    case ILS_as_julia: {
